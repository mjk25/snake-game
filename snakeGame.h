...
{
private:
    int speed, itemChange, maxwidth, maxheight, gateChange, flag=1;
    char direction, partchar, edgechar, grape, poison, booster; // partchar is the character representing the snake's body
